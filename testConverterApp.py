...
widget = Button(None, text="EXIT", bg="white", fg="red",font = ("Arial", 14, "bold"), relief = RAISED, bd=5, justify = CENTER, highlightbackground = "red", overrelief = GROOVE, activebackground = "green", activeforeground="blue", command=root.destroy).place(x=350,y=350)
#############################################################################################################################################
...
def TemperatureConverter():
    ...
    convertButton =Button (top, text = "Convert", font = ("Arial", 8, "bold"), relief = RAISED, bd=5, justify = CENTER, highlightbackground = "red", overrelief = GROOVE, activebackground = "white", activeforeground="blue", command = convert)
...
def sensex(event):
    webbrowser.open_new("githup.com")
def nifty(event):
    webbrowser.open_new(r"google.com")
def gold(event):
    webbrowser.open_new(r"hightec..com")
def silver (event):
    webbrowser.open_new(r"Youtube.com")
...
root.mainloop()
 ##Done! Glory be to the Almighty God for giving Kella the wisdom to develop this system 
 #This by his grace that am able to come this as far###